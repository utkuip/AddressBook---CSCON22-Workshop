...
var KTAppCalendar = function () {
    ...
    const q = e => {
        ...
        var o = {
            ...
            html: !0,
            title: "Ders Ozeti",
            content: '<div class="fw-bolder mb-2">' + x.eventName + '</div><div class="fs-7"><span class="fw-bold">Baslangic:</span> ' + n + '</div><div class="fs-7 mb-4"><span class="fw-bold">Bitis:</span> ' + a + '</div><div id="kt_calendar_event_view_button" type="button" class="btn btn-sm btn-light-primary">Detaylari Gor</div>'
        };
        ...
        N = () => {
            f.innerText = "Yeni Ders Oluştur", v.show();
                ...
                t.preventDefault(), y && y.validate().then((function (t) {
                    console.log("validated!"), "Valid" == t ? (_.setAttribute("data-kt-indicator", "on"), _.disabled = !0, setTimeout((function () {
                        _.removeAttribute("data-kt-indicator"), Swal.fire({
                            text: "Yeni Ders Basariyla Eklendi!",
                            icon: "success",
                            buttonsStyling: !1,
                            confirmButtonText: "Tesekkurler!",
                            customClass: {
                        ...
                        text: "Bir hatayla karsilasildi.Tekrar deneyin.",
                        icon: "error",
                        buttonsStyling: !1,
                        confirmButtonText: "Tesekkurler!",
                        customClass: {
        ...
        H = () => {
            E.addEventListener("click", (t => {
                t.preventDefault(), w.hide(), (() => {
                    f.innerText = "Dersi Düzenle", v.show();
                    const t = p.querySelectorAll('[data-kt-calendar="datepicker"]'),
                    ...
                    r.addEventListener("click", (e => {
                        ...
                        t.preventDefault(), y && y.validate().then((function (t) {
                            console.log("validated!"), "Valid" == t ? (_.setAttribute("data-kt-indicator", "on"), _.disabled = !0, setTimeout((function () {
                                ...
                                text: "Bir hatayla karsilaşildi. Tekrar deneyin",
                                icon: "error",
                                buttonsStyling: !1,
                                confirmButtonText: "Tesekkurler!",
                                customClass: {
    ...
    return {
        ...
        init: function () {
            ...
            w = new bootstrap.Modal(B), g = B.querySelector('[data-kt-calendar="event_name"]'), S = B.querySelector('[data-kt-calendar="all_day"]'), Y = B.querySelector('[data-kt-calendar="event_description"]'), h = B.querySelector('[data-kt-calendar="event_location"]'), T = B.querySelector('[data-kt-calendar="event_start_date"]'), M = B.querySelector('[data-kt-calendar="event_end_date"]'), E = B.querySelector("#kt_modal_view_event_edit"), L = B.querySelector("#kt_modal_view_event_delete"), F = document.getElementById("kt_calendar_app"), O = moment().startOf("day"), I = O.format("YYYY-MM"), R = O.clone().subtract(1, "day").format("YYYY-MM-DD"), G = O.format("YYYY-MM-DD"), K = O.clone().add(1, "day").format("YYYY-MM-DD"), (e = new FullCalendar.Calendar(F, {
                ...
                editable: !0,
                dayMaxEvents: !0,
                events: $('#denemehdn').val(),
                    //$.ajax({
                    //    method: "GET",
                    //    url: "/Schedule/GetLessons",
                ...
                fields: {
                    calendar_event_name: {
                        validators: {
                            notEmpty: {
                                message: "Ders Turu Secmek Zorunludur"
                            }
                        }
                    },
                    calendar_event_start_date: {
                        validators: {
                            notEmpty: {
                                message: "Tarih Secmek Zorunludur"
                            }
                        }
                    },
                ...
                t.preventDefault(), Swal.fire({
                    text: "Bu Dersi Silmek Istediginizden Emin Misiniz?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
